...
TEST_UI_SOURCES = tests/test_ui_handler.c src/ui_handler.c src/arena_allocator.c src/gravity_interactor.c src/gravity.c src/logging.c src/verlet.c src/main.c
